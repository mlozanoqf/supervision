...
*Not really. I rather prefer to ask for reports based on tasks or tasks progress. The process is rather simple: you send me a draft, I give you comments by email and/or Zoom, you incorporate my comments, you send me a new draft, and the process start again. *
...
8. More in future versions of this document.

# `r fontawesome::fa("file-alt")` Project structure.
...
## Discussion of results (sometimes discussion is a separate section).
...
## Complementary results (you may or may not need this).
