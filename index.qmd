...
```{r strategies, child = '1intro.qmd'}
```


```{r strategies, child = '2structure.Rmd'}
```


```{r strategies, child = '3style.Rmd'}
```

```{r strategies, child = '4udem.Rmd'}
```
...
```{r strategies, child = 'schedule pr26.Rmd'}
```
