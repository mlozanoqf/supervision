...
**`r fontawesome::fa("angle-right")` Red flags to treat as urgent.**
...
**`r fontawesome::fa("angle-right")` The dissertation must read as one coherent argument.**
...
**`r fontawesome::fa("angle-right")` Avoid overly complex structures that hide your main message.**
...
**`r fontawesome::fa("angle-right")` Write for clarity, not for sophistication.**
...
**`r fontawesome::fa("angle-right")` Literature reviews must build justification, not just describe sources.**
...
**`r fontawesome::fa("angle-right")` Methodology must show reasoning, alignment, and detail.**
...
**`r fontawesome::fa("angle-right")` Results must be explained, not only reported.**
...
**`r fontawesome::fa("angle-right")` Discussion and contribution must be explicit and evidence-based.**
...
**`r fontawesome::fa("angle-right")` Presentation should support the argument at the point of use.**
...
**`r fontawesome::fa("angle-right")` Topic selection should be ambitious but feasible.**
...
**`r fontawesome::fa("angle-right")` Three examples of what "good" looks like.**
