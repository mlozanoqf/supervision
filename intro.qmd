...
*There are several alternatives to write your project. You can use MS-Word, Google Docs, Overleaf, R Markdown, or any other $\LaTeX{}$ compiler. My recommendation is to use Quarto within RStudio.*
